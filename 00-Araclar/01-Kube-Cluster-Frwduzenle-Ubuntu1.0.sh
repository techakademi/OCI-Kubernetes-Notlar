...
sudo iptables -A INPUT -p tcp -m multiport --dports 80,443,8443,2379,2380,6443,8090,8091,10250,10251,10252,10255,6783  -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT
sudo iptables -A OUTPUT -p tcp -m multiport --dports 80,443,8443,2379,2380,6443,8090,8091,10250,10251,10252,10255,6783 -m conntrack --ctstate ESTABLISHED -j ACCEPT
